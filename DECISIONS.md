...
### 2. Trade-offs Made Under Time Limit & What I’d Do with a Full Week
...
### 3. AI Tool Usage & What Was Personally Engineered & Verified

**How I Used AI:**  
I used AI as a high-speed pair programmer and sounding board — accelerating initial CSS class scaffolds, drafting game database schemas, and testing regex patterns for iframe embed sanitization.

**What I Personally Engineered, Debugged & Verified:**
1. **Scroll Pacing & Hold Buffers**: AI initially scrolled through sections uniformly, causing users to skip past reading content. I personally calculated the sticky scroll domain ranges, added 2-second hold reading buffers (`0.75 -> 1.00`), and clamped scroll speed so users never get motion-sick.
...
3. **Anti-Scraping & Code Hardening (`securityGuard.js`)**: Implemented low-level DOM event interception to disable unauthorized asset theft (blocking `F12`, `Ctrl+Shift+I`, `Ctrl+U`, `Ctrl+S`, dragging `<img>` elements, and disabling source maps in Vite production builds).
